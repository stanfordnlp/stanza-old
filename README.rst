...
::
    ...
    git --local alias.stanza-update 'subtree pull --prefix third-party/stanza stanza develop --squash'
    git --local alias.stanza-push 'subtree push --prefix third-party/stanza stanza develop'
